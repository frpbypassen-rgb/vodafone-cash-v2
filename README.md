...
تولد أداة الإصلاح أسرار المصادقة عشوائيًا فقط إذا كانت مفقودة أو ضعيفة أو مكررة، ولا تطبع قيمها. تدوير أسرار JWT والجلسة يسجل خروج الجلسات القديمة، وهو السلوك الآمن بعد اكتشاف إعادة استخدام سر واحد.
...
تتكون مجموعة الاختبارات الحالية من **108 مجموعات و594 اختبارًا**. الرقم مرجعي وقد يتغير؛ نتيجة GitHub Actions للـCommit الجاري هي المرجع النهائي.
