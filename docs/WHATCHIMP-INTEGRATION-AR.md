...
- البريد قناة بديلة لحساب واحد فقط: بريد صالح مع `otpDeliveryChannel=email` من شاشة تعديل الحساب («إرسال رمز التحقق عبر البريد»). الحسابات الأخرى تبقى على WhatsApp.
