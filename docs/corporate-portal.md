...
| القيمة | الاسم |
| --- | --- |
| `day` | نهاري — أسطح ملوّنة للشركات (أخضر مزرق + نيلي)، لوحة باردة مزرقة، بطاقات بيضاء، شارات حالة ملوّنة |
| `night` | ليلي — كحلي/فحمي مع لمسات سماوية وفيروزية، حلقات تركيز مضيئة، جداول واضحة |
| `pharaonic` | فرعوني — أزرار معبد/مسلة، رمل وذهب وفيروز، كثافة مهنية. الزخرفة الثقيلة تنتظر `cp-art-ready` وتتوقف مع `prefers-reduced-motion` |
