...
> Flutter integration note: the current authoritative mobile contract is
> [Flutter-Mobile-API-Contract.md](./Flutter-Mobile-API-Contract.md).
> This older reference may contain legacy examples and should not be used as the final Flutter source of truth.
