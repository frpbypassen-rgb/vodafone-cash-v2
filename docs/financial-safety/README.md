...
| 4. حساب مقاصة للتحويل الخارجي | **مفتوح.** لم يُنفَّذ. التحويل الخارجي يبقى خصمًا من طرف واحد. |
...
### 4. قيد التحويل الخارجي ليس قيدًا مزدوجًا داخل الدفاتر — POLICY STOP ما زال مفتوحًا
