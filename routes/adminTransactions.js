...
router.get('/transactions', async (req, res) => {
    try {
        ...
        let query = {};
        // ✅ إصلاح NoSQL Regex Injection — تعقيم مصطلح البحث
        if (search) {
        ...
        const allBots = await ExecutorBot.find({});
        const allBotsMap = {};
        allBots.forEach(b => { allBotsMap[b._id.toString()] = b.name; });
